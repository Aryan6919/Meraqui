  ...
  return (
    <main className='w-full sm:mt-40 ' id='about'>
      ...
      <section className='w-[95%] sm:flex sm:flex-row  h-fill my-8 mx-auto h-fill sm:mb-16'>
        ...
        <div className='mx-auto w-[95%] sm:w-[55%] sm:relative sm:right-[%]'>
      ...
      <section className='w-[95%] sm:flex sm:flex-row  h-fill my-8 mx-auto h-fill sm:mb-16 sm:mt-56'>
        <div className='w-full sm:w-[55%] sm:h-[55vh] sm:flex sm:flex-col sm:ml-12 sm:justify-center' style={margin}>
          <div className='w-full sm:mb-8'>
            <h1 className='text-3xl text-left sm:text-5xl font-quicksand font-[400] sm:ml-2 '>Values</h1>
          </div>
          <div className='w-full mt-3'>
            <p className='text-left sm:w-[75%] font-poppins font-[300] sm:text-[1.2rem] leading-[35px]'>
