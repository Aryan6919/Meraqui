...
const About = () => {
  ...
  return (
    <main className='w-full sm:mt-40 ' id='about'>
      <section className='w-[95%] sm:flex sm:flex-row  h-fill my-8 mx-auto h-fill sm:mb-16'>
        <div className='w-full sm:w-[55%] sm:h-[55vh] sm:flex sm:flex-col sm:ml-12 sm:justify-center'>
          <div className='w-full sm:mb-8'>
            <h1 className='text-3xl text-left sm:text-5xl font-quicksand font-[400] sm:ml-2 mt-16 '>About Meraqui</h1>
          </div>
      ...
      <section className='w-[95%] sm:flex sm:flex-row  h-fill my-8 mx-auto h-fill sm:mb-16'>
        <div className='w-full sm:w-[55%] sm:h-[55vh] sm:flex sm:flex-col sm:ml-12 sm:justify-center'>
          <div className='w-full sm:mb-8'>
            <h1 className='text-3xl text-left sm:text-5xl font-quicksand font-[400] sm:ml-2 mt-20'>Vision Statement</h1>
          </div>
          <div className='w-full mt-3'>
            <p className='text-left sm:w-[75%] font-poppins font-[300] sm:text-[1.2rem] leading-[35px]'>
      ...
      <section className='w-[95%] sm:flex sm:flex-row sm:my-8 h-fill  sm:mb-16 mx-auto h-fill '>
        <div className='w-full sm:w-[55%] sm:h-[55vh] sm:flex sm:flex-col sm:ml-12 sm:justify-center sm:mt-24'>
          <div className='w-full sm:mb-8'>
            <h1 className='text-3xl text-left sm:text-5xl font-quicksand font-[400] sm:ml-2'>Mission Statement</h1>
          </div>
          <div className='w-full mt-3'>
            <p className='text-left sm:w-[75%] font-poppins font-[300] sm:text-[1.2rem] leading-[35px]'>
...
<br></br>
         ...
         <div className='mx-auto w-[95%] sm:w-[55%] sm:relative sm:right-[-5%]'>
          <img className=' sm:w-[100%] h-[68vh] ' src={M} alt="" />
        </div> 
      </section>
      <section className='w-[95%] sm:flex sm:flex-row  h-fill my-8 mx-auto h-fill sm:mb-16  '>
        <div className='w-full sm:w-[55%] sm:h-[55vh] sm:flex sm:flex-col sm:ml-12 sm:justify-center'>
          <div className='w-full sm:mb-8'>
            <h1 className='text-3xl text-left sm:text-5xl font-quicksand font-[400] sm:ml-2 sm:mt-80 pt-40'>Values</h1>
          </div>
          <div className='w-full mt-3'>
            <p className='text-left sm:w-[75%] font-poppins font-[300] sm:text-[1.2rem] leading-[35px]'>
...
<br></br>
      ...
      <section className='w-full sm:mt-40 '>
        <div className='w-full mb-4 sm:mb-16'>
          <h2 className='text-3xl sm:text-4xl font-poppins font-[300] text-center pt-40 mt-16'>Our Philosophy</h2>
        </div>
