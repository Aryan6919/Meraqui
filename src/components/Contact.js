...
const Contact = () => {
    return (
        ...
        <main className='w-full sm:mt-24 ' id='about'>
                ...
                <div className='sm:flex sm:flex-row sm:w-[93%] sm:mx-auto'>
                    <div className='w-full mt-4 sm:w-[60%] sm:flex sm:flex-col sm:justify-center'>
                        <div className='w-full text-left sm:w-[100%]'>
                            <h3 className='text-2xl sm:text-3xl font-quicksand font-medium'>Let's Get in touch</h3>
                        </div>
                        <div className='w-full mt-2 sm:w-[70%] sm:mt-8'>
                            <p className='text-left sm:w-full sm:text-[1.2rem]'>
                                Workforce planning can help an organization better prepare for the future and
                                forecast potential challenges. Connect with us to find the workforce that
                                fits your business.
                            </p>
                        </div>
                    ...
                    <div className='mt-4 sm:w-[60%] sm:relative sm:right-[-10%]'>
                        <img className=' sm:w-[100%] ' src={"https://images.unsplash.com/photo-1516387938699-a93567ec168e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2071&q=80"} alt="" />
                    </div>
                </div>
            ...
            <section className='sm:flex sm:flex-row sm:mt-12 w-full mb-4'>
                <div className='sm:relative sm:left-[-18%] h-fill sm:w-[60%] sm:h-[65vh]'>
                    <div className='sm:relative sm:left-[20%] sm:h-[65vh] sm:w-[90%] bg-getInTouch h-[40vh] bg-center bg-cover w-[100%]'>
                        <div className='w-full sm:flex sm:flex-col sm:justify-center sm:h-[65vh] h-[40vh] bg-black bg-opacity-[0.6] sm:bg-opacity-[0.5] text-white'>
                            ...
                            <div className='w-full  sm:flex sm:justify-end sm:pr-18 py-4'>
                                <p className='w-[75%]  text-left   sm:text-left sm:w-[70%]  font-poppins font-[300] pl-12'>
