...
const Footer = () => {
  return (
    <footer className=' bg-[#0d0d0d] text-white w-[100%] sm:h-fit pb-2  sm:pb-0 flex flex-col  sm:pt-8  font-quicksand '>
         <div className='flex flex-col sm:flex-row sm:w-[80%]  sm:mx-auto sm:justify-center sm:mb-8 sm:pb-8'> 
            <div className='w-full sm:flex sm:flex-row sm:justify-around sm:w-[73%]'>
                <div className=' flex flex-col w-full sm:w-[100%] sm:justify-between sm:h-[35vh] sm:text-left'>
                    <div className='w-[80%] ml-[20px] sm:ml-8  flex justify-start mt-4 sm:w-[100%] '>
                        <img className='w-[60%] flex justify-center  sm:w-[50%] text-white' src={require('../image/meraquiLogo.png')} alt="" />
                    </div>
                    <div className='flex flex-row justify-center w-full mt-12 sm:w-[76%] sm:mt-8 px-4'>
                        <span className='sm:mt-2 w-[10%] sm:w-[10%]  text-[2rem] text-cyan-400 mr-2 sm:text-[2.8rem] sm:h-fill'><img className='lg:w-[65%]' src={require("../image/location.png")} alt="" /></span>
                        <div>
                            <p className=' max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-poppins font-[400] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col'>
                                Meraqui Ventures Pvt. Ltd., 
                                Pranik Chambers,
                            </p>
                            <p className=" max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-quicksand font-[500] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col">
                                B-125, 1st Floor, Saki Vihar Road, Near Saki Naka Metro Station,
                                Sakinaka, 
                            </p>
                            <p className='max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-quicksand font-[500] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col'>
                            Andheri
                            </p>
                            <p className='max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-quicksand font-[500] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col'>(E), Mumbai – 400072, India</p>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row justify-start w-full mt-4 sm:w-[66%] sm:mt-8 px-4'>
                        ...
                        <p className="max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-quicksand font-[500] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col mt-2">+91-9560772719</p>
                    </div>
                    ...
                    <div className='flex flex-row justify-start w-full mt-4 sm:w-[66%] sm:mt-8 px-4'>
                        ...
                        <p className="max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-quicksand font-[500] sm:text-[13px] sm:ml-1  sm:flex sm:justify-center sm:flex-col ">contact@meraqui.com</p>
                    </div>
                </div>
            </div>
            <div className='w-full flex flex-row mt-8 justify-evenly   sm:w-[85%] sm:mt-12'>
                <div className='w-[30%] '>
                    <div className='w-[100%] text-[0.85rem] sm:w-[80%] sm:flex sm:flex-col sm:justify-center' >
                        <h3 className='w-fit ml-4  border-b-[3px] border-cyan-500 sm:text-[1.3rem] font-quicksand font-[500]'>Quick Links</h3>
                        <ul className="items-left sm:leading-[40px] mt-[8px] flex flex-col justify-evenly h-40 font-quicksand font-[500]  sm:text-left sm:ml-4 sm:mt-[21px]">
                ...
                <div className='w-[33%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem] ' >
                        <div className='ml-4 border-b-[3px] border-cyan-500 w-[75%]'>
                            <h3 className='w-fit ml-4 sm:ml-0 text-left w-[]   sm:text-[1.3rem] font-quicksand font-[500]'>Services</h3>
                        </div>
                        <ul className= "items-left sm:leading-[20px] mt-[45px] flex flex-col justify-evenly h-40 font-quicksand font-[500]  sm:mt-[42px] sm:text-left sm:ml-4">
                ...
                <div className='w-[30%] sm:w-[35%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem]' >
                        ...
                        <ul className="sm:w-[100%] sm:mt-[20px] items-left mt-[28px] flex flex-col justify-center h-40 font-quicksand font-[500]  sm:text-left sm:ml-4">
                        
                            <li className='sm:mb-[25px] mb-[30px]' ><Link to="/services/warehousing">3PL Warehousing</Link></li>
                            <li className=' mb-[30px] sm:mb-0'><Link to="/services/workforce">Workforce Mangement(GIG)</Link></li>
        ...
        {/* <div className='w-full sm:mt-16 mt-16'>
            ...
            <div className=' flex flex-row w-full justify-evenly mt-2 sm:mt-12  sm:w-[40%] sm:mx-auto'>
                <div className="ml-8">
            ...
            <div className='bg-cyan-100 w-full sm:h-fill text-black sm:mt-4'>
                <div className=  'my-4 sm:my-2  flex flex-row w-full justify-evenly   sm:w-[60%] sm:mx-auto  font-quicksand font-[600]' >
                    <p>©Copyright 2022@MERAQUI</p>
                </div>
            </div>  
