            ...
            <div className='w-full sm:flex sm:flex-row sm:justify-around sm:w-[73%]'>
                <div className=' flex flex-col w-full sm:w-[100%] sm:justify-between sm:h-[35vh] sm:text-left'>
                    ...
                    <div className='flex flex-row justify-center w-full mt-12 sm:w-[76%] sm:mt-8 px-4'>
                        <span className='sm:mt-2 w-[25%] sm:w-[15%]  text-[2rem] text-cyan-400 mr-2 sm:text-[2.8rem] sm:h-fill'><img src={require("../image/location.png")} alt="" /></span>
                        <div>
                            ...
                            <p className='max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-poppins font-[400] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col'>(E), Mumbai – 400072, India</p>
                        </div>
                    </div>
                    {/* <div className='text-left w-[93%]'> */}
                    <div className='flex flex-row justify-start w-full mt-4 sm:w-[66%] sm:mt-12 px-4'>
                        <span className='sm:w-[15%] text-[2rem] text-cyan-400 mr-2 sm:text-[2.8rem] sm:h-fill'><img src={require("../image/phone.png")} alt="" /></span>
                        <p className="max-w-full sm:w-[100%] text-left sm:leading-[1.8] font-poppins font-[400] sm:text-[13px]  sm:flex sm:justify-center sm:flex-col">+91-9560772719</p>
                    </div>
                    {/* <div className='flex flex-row justify-center w-full sm:w-[100%] sm:mt-4 mt-4 relative left-[-14%] sm:left-0'> */}
                    <div className='flex flex-row justify-start w-full mt-4 sm:w-[66%] sm:mt-12 px-4'>
                        <span className='sm:w-[15%] text-[2rem] text-cyan-400 mr-2 sm:text-[2.8rem] sm:h-fill'><img src={require("../image/letter.png")} alt="" /></span>
            ...
            <div className='w-full flex flex-row mt-8 justify-evenly   sm:w-[85%] sm:mt-12'>
                ...
                <div className='w-[33%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem] ' >
                        <div className='ml-4 border-b-[3px] border-cyan-500 w-[75%]'>
                            <h3 className='w-fit ml-4 sm:ml-0 text-left w-[]   sm:text-[1.3rem] font-poppins font-[400]'>Services</h3>
                        </div>
                        <ul className= "items-left sm:leading-[20px] mt-[45px] flex flex-col justify-evenly h-40 font-poppins font-[300]  sm:mt-[42px] sm:text-left sm:ml-4">
                ...
                <div className='w-[30%] sm:w-[35%]'>
                    <div className='w-[100%] sm:w-[60%] sm:flex sm:flex-col sm:justify-center text-[0.85rem]' >
                        ...
                        <ul className="sm:w-[100%] sm:mt-[20px] items-left mt-[28px] flex flex-col justify-center h-40 font-poppins font-[300]  sm:text-left sm:ml-4">
                        
                            <li className='sm:mb-[25px] mb-[30px]' ><Link to="/services/warehousing">3PL WAREHOUSING</Link></li>
                            <li className=' mb-[30px] sm:mb-0'><Link to="/services/workforce">GIG</Link></li>
