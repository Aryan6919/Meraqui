            ...
            <section className='sm:flex sm:flex-row w-[95%] mx-auto  font-poppins font-[300] hidden '>
                ...
                >
                    ...
                    <SwiperSlide className='sm:flex sm:flex-row w-[95%] mx-auto  mt-4   '>
                        ...
                        <section className=' sm:flex sm:w-[95%] sm:flex-row w-[90%] mx-auto  mt-4 bg-white shadow-lg rounded-lg  p-2 bg-[#E5FBFF]'>
                            <div className=' sm:w-[100%] h-[30vh] sm:h-auto my-auto  flex flex-col justify-center'>
                                ...
                                <div className='w-full mt-4 sm:mt-0'>
                                    <p className=' w-[85%] text-left sm:text-xl  font-poppins font-[300] text-[0.6rem] p-4'>
                                        {slides1[0].body}
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <SwiperSlide className='pt-4 '>
                                    <div className='w-[100%] sm:w-[100%]  mb-4 relative right-[0%] bg-[#E5FBFF] '>
                                        <img src={slides2[0].url} alt="photo1" className=' pr-4 mt-2 mb-2 pb-4 w-[100%] flex  h-[20vh] sm:h-[50vh] sm:w-[100%] mr-2 opacity-[1] bg-[#E5FBFF] align-middle ' />
                    ...
                    <SwiperSlide className='sm:flex sm:flex-row w-[95%] sm:-[100%] mx-auto  mt-4   '>
                        ...
                        <section className='sm:flex sm:w-[95%] sm:flex-row w-[90%] mx-auto  mt-4 bg-white  border-[2px] shadow-lg rounded-lg  p-2 bg-[#FAEBFF]'>
                            <div className=' sm:w-[100%] h-[30vh] sm:h-auto my-auto  flex flex-col justify-center'>
                                <div className='flex w-[100%]'>
                            ...
                            >
                                <SwiperSlide className='pt-4'>
                                    <div className='w-[100%] sm:w-[100%]  mb-4 relative right-[0%] bg-[#FAEBFF] '>
                                        <img src={slides2[1].url} alt="photo1" className=' pr-4 mt-2 mb-2 pb-4  w-[100%] flex  h-[20vh] sm:h-[50vh] sm:w-[100%] mr-2 opacity-[1] bg-[#FAEBFF] ' />
                    ...
                    <SwiperSlide className='sm:flex sm:flex-row w-[95%] sm:-[100%] mx-auto  mt-4   '>
                        ...
                        <section className='sm:flex sm:w-[95%] sm:flex-row w-[90%] mx-auto  mt-4 bg-white  border-[2px] shadow-lg rounded-lg  p-2  bg-[#FAFFEE]'>
                            <div className=' sm:w-[100%] h-[30vh] sm:h-auto my-auto  flex flex-col justify-center'>
                                <div className='flex w-[100%]'>
                            ...
                            >
                                <SwiperSlide className='pt-4'>
                                    <div className='w-[100%] sm:w-[100%]  mb-4 relative right-[0%] bg-[#FAFFEE]'>
                                        <img src={slides2[2].url} alt="photo1" className=' pr-4 mt-2 mb-2 pb-4  w-[100%] flex  h-[20vh] sm:h-[50vh] sm:w-[100%] mr-2 opacity-[1] bg-[#FAFFEE]' />
                    ...
                    <SwiperSlide className='sm:flex sm:flex-row w-[95%] sm:-[100%] mx-auto  mt-4   '>
                        ...
                        <section className='sm:flex sm:w-[95%] sm:flex-row w-[90%] mx-auto  mt-4 bg-white  border-[2px] shadow-lg rounded-lg  p-2 bg-[#FFE9E9]'>
                            <div className=' sm:w-[100%] h-[30vh] sm:h-auto my-auto  flex flex-col justify-center'>
                                <div className='flex w-[100%]'>
                                    <p className='w-[100%] sm:w-[65%] text-left sm:text-4xl font-quicksand font-[400] p-4'>
                                        {slides4[0].header}
                            ...
                            >
                                <SwiperSlide className='pt-4 '>
                                    <div className='w-[100%] sm:w-[100%]  mb-4 relative right-[0%] bg-[#FFE9E9] '>
                                        <img src={slides2[3].url} alt="photo1" className=' pr-4 mt-2 mb-2 pb-4  w-[100%] flex  h-[20vh] sm:h-[50vh] sm:w-[100%] mr-2 opacity-[1] bg-[#FFE9E9] ' />
