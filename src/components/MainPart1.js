    ...
    return (
        <main className='flex flex-col w-full mx-2 font-bold sm:w-[85%] sm:mx-auto'>
            <section className='w-full mt-4 font-thin'>
                <h3 className='text-[1.5rem] sm:text-5xl sm:my-4 font-quicksand font-[400]'>Why choose Meraqui?</h3>
            </section>
            
            {/* Carousel */}

            <section className='sm:flex sm:flex-row w-[95%] mx-auto  font-quicksand font-[450] hidden '>
                ...
                >
                    ...
                    <SwiperSlide className='sm:flex sm:flex-row w-[95%] mx-auto     '>
                        ...
                        <section className=' sm:flex sm:w-[95%] sm:flex-row w-[90%] mx-auto  mt-4 bg-white shadow-lg  p-2 bg-[#E5FBFF]'>
                            <div className=' sm:w-[100%] h-[30vh] sm:h-auto my-auto  flex flex-col justify-center'>
                                ...
                                <div className='w-full mt-4 sm:mt-0'>
                                    <p className=' w-[85%] text-left sm:text-xl  font-quicksand font-[500] text-[0.6rem] p-4'>
                                        {slides1[0].body}
                                    </p>
                                </div>
                            </div>
                    ...
                    <SwiperSlide className='sm:flex sm:flex-row w-[95%] sm:-[100%] mx-auto    '>
                        ...
                        <section className='sm:flex sm:w-[95%] sm:flex-row w-[90%] mx-auto  mt-4 bg-white  border-[2px] shadow-lg   p-2 bg-[#FAEBFF]'>
                            <div className=' sm:w-[100%] h-[30vh] sm:h-auto my-auto  flex flex-col justify-center'>
                                ...
                                <div className='w-full mt-4 sm:mt-0'>
                                    <p className=' w-[85%] text-left sm:text-xl  font-quicksand font-[450] text-[0.6rem] p-4'>
                                        {slides2[0].body}
                                    </p>
                                </div>
                            </div>
            ...
            {/* mobile view */}
            <section className='sm:hidden flex flex-row w-[95%] mx-auto font-quicksand font-[450]  '>
                <div className=' w-[100%] flex flex-col justify-center'>
                    ...
                    <div className='w-full mt-4 sm:mt-8'>
                        <p className=' w-[85%] text-left sm:text-2xl  font-quicksand font-[450] text-[0.6rem]'>
                            {slides1[0].body}
                        </p>
                    </div>
                </div>
