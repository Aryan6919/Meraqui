    ...
    <main className='w-full mt-10 sm:mt-16 font-bold sm:w-[85%] sm:mx-auto sm:font-normal sm:h-full'>
      ...
      >
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2 ' >{slides[0].title}</h3> 
        </SwiperSlide>
        ...
        <SwiperSlide>
          ...
          <h3 className='  text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2  ' >{slides[1].title}</h3>  
        </SwiperSlide>
        <SwiperSlide>
          ...
          {/* <div className= ' pt-120 text-white w-full h-[25vh] sm:h-[40vh] bg-opacity-[0.6]'>  */}
                  <h3 className='   text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2 ' >{slides[2].title}</h3>
        ...
        <SwiperSlide>
          ...
          <h3 className='  text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2 ' >{slides[3].title}</h3> 
        </SwiperSlide>
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2 ' >{slides[4].title}</h3>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl  pt-120 mt-2' >{slides[5].title}</h3>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2 ' >{slides[6].title}</h3> 
        </SwiperSlide>
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl pt-120 mt-2 ' >{slides[7].title}</h3>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl' >{slides[8].title}</h3>
        </SwiperSlide>
        <SwiperSlide>
          ...
          <h3 className=' text-2xl font-quicksand font-[550] sm:text-2xl' >{slides[9].title}</h3>
        </SwiperSlide>
      ...
      <section className='hidden sm:block mt-12 sm:h-[90vh]'>
        <div className='w-full flex flex-col sm:h-[6vh] h-[0vh]'>
            <div className='w-full'>
              <h3 className='w-full text-3xl  sm:text-5xl font-quicksand font-[550]'>Meraqui in news</h3>
            </div>
            {/* <div className='w-full flex justify-center mt-2 sm:mt-4'> 
        ...
        >
          <SwiperSlide className=''>
              <div className=' mt-10  h-full pb-8 sm:pb-0 mx-auto relative   group shadow-md w-[95%] sm:flex sm:flex-col  sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    <div className='text-left text-[1.1rem] font-quicksand  font-[550] sm:w-[100%]'>
                      <h3>{newsInfo[0].caption}</h3>
                    </div>
                    <div className='text-left text-[0.8rem] mt-4  '>
                      <p className='font-quicksand font-[500] sm:h-[15vh] overflow-y-auto overflow-x-hidden leading-[1.9] text-justify  pr-2 duration-500'>{newsInfo[0].content}</p>
                    </div>
                    ...
                    {/* <a href='https://www.aninews.in/news/business/business/co-founders-shalin-maheshwari-lalit-singh-setting-new-benchmark-for-helping-blue-collar-workforce-through-their-startup-meraqui20220520185135/' target='blank'><FaLinkedin className='text-[4rem]  w-[50%] text-cyan-300' /></a> */}
                      ...
                      <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem] font-quicksand font-[550]' href="https://www.cxooutlook.com/the-future-of-hr-and-hiring-in-the-post-pandemic-era/">Read more</a>
                    </div>
          ...
          <SwiperSlide>
              <div className=' mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[95%] sm:flex sm:flex-col   sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    <div className='text-left text-[1.1rem] font-quicksand font-bold [550] sm:w-[100%]'>
                      <h3>{newsInfo[1].caption}</h3>
                    </div>
                    <div className='text-left text-[0.8rem] mt-4  '>
                      <p className='font-quicksand font-[550] sm:h-[15vh] overflow-y-auto overflow-x-hidden text-justify leading-[1.9]  pr-2 duration-500'>{newsInfo[1].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                     {/* <a href='https://www.englandnewsportal.com/news/co-founders-shalin-maheshwari-lalit-singh-setting-new-benchmark-for-helping-blue-collar-workforce-through-their-startup-meraqui20220520185127/' target='blank'><FaLinkedin className='text-[4rem]  w-[50%] text-cyan-300' /></a> */} 
                      {/* <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' a href=" https://www.linkedin.com/company/meraquii" /> */}
                      <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem] font-quicksand font-[550]' href="https://yourstory.com/2022/04/waas-startup-meraqui-blue-collar-workforce-relevant-gigs">Read more</a>
                    </div>
                  </div>
              </div>
          </SwiperSlide>
          <SwiperSlide>
              <div className='  mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[95%] sm:flex sm:flex-col  sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4 '>
                      <p className='font-quicksand font-[500] sm:h-[15vh] overflow-y-auto overflow-x-hidden leading-[1.9] text-justify  pr-2 duration-500'>{newsInfo[2].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                    {/* <a href='https://www.zee5.com/articles/co-founders-shalin-maheshwari-lalit-singh-setting-new-benchmark-for-helping-blue-collar-workforce-through-their-startup-meraqui' target='blank'><FaLinkedin className='text-[4rem]  w-[50%] text-cyan-300' /></a> */}
                      {/* <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' a href="  https://www.linkedin.com/company/meraquii" /> */}
                      <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem] font-quicksand font-[550]' href="https://startuptalky.com/technology-in-blue-collar-workforce-management-shalin-maheshwari-meraqui/">Read more</a>
                    </div>
                  </div>
              </div>
          </SwiperSlide>
          <SwiperSlide>
              <div className='  mt-10  h-full pb-8 sm:pb-0 mx-auto relative    group shadow-md w-[95%] sm:flex sm:flex-col sm:h-[60vh]'>
                  ...
                  <div className='w-full flex flex-col justify-evenly sm:h-[25vh] mt-8 sm:w-[100%] sm:justify-evenly sm:mx-auto px-2'>
                    ...
                    <div className='text-left text-[0.8rem] mt-4 '>
                      <p className='font-quicksand font-[500] sm:h-[15vh] overflow-y-auto overflow-x-hidden leading-[1.9] text-justify  pr-2 duration-500'>{newsInfo[3].content}</p>
                    </div>
                    <div className='text-right flex flex-row justify-end w-full sm:justify-none sm:mb-4 sm:text-right'>
                    {/* <a href='https://www.londonchannelnews.com/news/co-founders-shalin-maheshwari-lalit-singh-setting-new-benchmark-for-helping-blue-collar-workforce-through-their-startup-meraqui202205201851' target='blank'><FaLinkedin className='text-[4rem]  w-[50%] text-cyan-300' /></a> */}
                       {/* <FaLinkedin className='text-4xl mb-2 w-[20%] text-cyan-300' a href=" https://www.linkedin.com/company/meraquii"/> */} 
                      {/* <a href="">Read More</a> */}
                      <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem] font-quicksand font-[550]' href="https://www.londonchannelnews.com/news/co-founders-shalin-maheshwari-lalit-singh-setting-new-benchmark-for-helping-blue-collar-workforce-through-their-startup-meraqui20220520185127/">Read more</a>
                    </div>
                  </div>
              </div>
          </SwiperSlide>
