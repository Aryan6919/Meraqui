...
{url: require("../image/img/fourth.jpg"),
  ...
  const newsInfo = [
      ...
      content:"The Union Budget 2022-23 is all set to be presented by the Union Finance & Corporate Affairs Minister Nirmala Sitharaman on 1st February, 2022 in Paperless form. ",
      date:"02/06/23",
      publication:"publication",
      ...
      content:"Meraqui's proprietary tech stack Sheldon workflow covers all aspects of hiring and managing -- from facilitating recruiters and nodes to conducting interviews.",
      publication:"publication",
