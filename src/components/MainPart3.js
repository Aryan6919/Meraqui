    ...
    <main className='w-full h-fill mt-4 sm:mt-24 sm:w-[75%] sm:mx-auto'>
      <section className='flex flex-col justify-center mt-20  sm:mt-0'>
        <div className='w-full'>
          <h2 className='text-3xl sm:text-5xl font-quicksand font-[500]'>Featured blogs</h2>
        </div>
      ...
      <section className='flex flex-col w-full mt-8 rounded sm:h-[32vh] shadow-md pb-8'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          ...
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            <h3 className=' text-[1.1rem] font-bold [600] font-quicksand sm:w-[100%] '>IBM Power</h3>
            <div className='flex justify-center w-full mt-2'>
              <p className=' sm:h-[15vh] sm:w-[100%] sm:mr-8 sm:text-[1rem] sm:leading-[1.9]  font-quicksand font-[600]'>
            ...
            <div className='w-full sm:text-right sm:w-[94%] sm:mt-8'>
              <a className='text-[0.8rem] border-b-[1px] border-cyan-400 sm:text-[1rem] font-quicksand font-[600]' href="#main">Read more</a>
            </div>
          </div>
        </div>

      </section>
      <section className='flex flex-col w-full mt-6 rounded sm:h-[32vh] shadow-md pb-8 font-quicksand font-[600]'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          <div className='w-full flex justify-center sm:w-[37%] sm:h-[25vh]  sm:inline sm:mr-8 sm:ml-4'>
          ...
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            <h2 className=' text-[1.1rem] font-bold [300] sm:width-[100%]'>6G Technology</h2>
            <div className='flex justify-center w-full mt-2'>
              <p className=' sm:h-[15vh] sm:w-[100%]  sm:text-[1rem] sm-leading-[1.9] font-quicksand font-[600]  '>
       ...
       <section className='h-[4vh] w-full mb-10 flex flex-col justify-evenly sm:my-9'>
        {/* <a href="/viewall" width="102px">View All</a> */}
