      ...
      <section className='flex flex-col w-full mt-8 rounded sm:h-[32vh] shadow-md pb-8'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          ...
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            <h3 className=' text-[1.1rem] font-bold [300] font-poppins sm:w-[100%] '>IBM Power</h3>
            <div className='flex justify-center w-full mt-2'>
              <p className=' sm:h-[15vh] sm:w-[100%] sm:mr-8 sm:text-[1rem] sm:leading-[1.9]  font-poppins font-[500]'>
      ...
      <section className='flex flex-col w-full mt-6 rounded sm:h-[32vh] shadow-md pb-8 font-poppins font-[300]'>
        <div className='flex flex-col w-full sm:flex-row sm:justify-center sm:text-left sm:h-[32vh]'>
          ...
          <div className='w-full flex flex-col justify-center sm:w-[80%] sm:h-[30vh]  mt-4 sm:text-left'>
            ...
            <div className='flex justify-center w-full mt-2'>
              <p className=' sm:h-[15vh] sm:w-[100%]  sm:text-[1rem] sm-leading-[1.9] font-poppins font-[500]  '>
