...
const Navbar = () => {
  ...
  return (
    <nav className=' max-w-full flex flex-col justify-between mx-1 sm:mx-0 sm:bg-[#FFFFFF]  mt-4 sm:mt-0 sm:py-4  sm:fixed sm:bg-opacity-[0.95] z-50 sm:w-full sm:h-[8vh]'>
        <div className="max-w-full flex flex-row justify-between mx-1  mt-1 sm:justify-evenly sm:relative sm:bottom-[50%]">
            ...
            <ul className='  w-[75%] hidden  md:flex sm:flex sm:flex-row sm:justify-evenly md:justify-evenly font-poppins font-[300] sm:text-[1rem]'>
                ...
                <Link to='/about' onClick={() => setIsHidden(false)} className=" hover:text-slate-400 mr-8 mt-2">About</Link>
