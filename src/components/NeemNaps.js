  ...
  return (
    <main className='sm:w-[100%] sm:mx-auto'>
        <section className='sm:mt-32 sm:flex sm:w-[90%] sm:mx-auto'>
              ...
              <div className="sm:justify-center  sm:mt-0 sm:mb-8 sm:w-[65%] sm:flex sm:flex-col">
                    <div className=' ml-2  flex flex-col sm:justify-between sm:h-[30vh] '>
                        <h1 className='font-quicksand font-[400] text-4xl text-left sm:text-5xl w-[75%] sm:w-[95%] sm:leading-[1.4] pb-8' >
                            NAPS AND NATS
                        </h1>
                        <p className='text-left sm:w-[98%]  sm:mt-0 font-poppins font-[300] sm:text-[1.2rem] leading-[35px]'>
              ...
              <div className='sm:relative sm:right-[-15%] sm:w-[90%] h-[80vh]'>
        ...
        <section className='w-full my-12 sm:mt-20'>
          <div className='w-full mb-4 sm:mb-16'>
            <h2 className='text-3xl sm:text-5xl font-quicksand font-[400] pt-8'>About service</h2>
          </div> 
          <div className='sm:flex sm:w-full sm:mt-12 mb-12 sm:mb-0'>
            <div className='sm:w-[60%] ml-2 sm:ml-20'>
              <div className='w-full flex justify-start'>
                <h3 className='sm:text-4xl text-2xl font-poppins font-[300]'>NAPS</h3>
              </div>
              <p className='text-left font-poppins font-[300] mt-2 sm:mt-8 leading-[35px] sm:text-[1.2rem] sm:mr-4'>NAPS is a scheme launched by the Government of India to promote apprenticeship. Apprenticeship Training consists of Basic Training and On-The-Job Training at the workplace in the industry. 
...
It has been observed that organizations face issues like charting annual apprenticeship plans, mobilization of eligible candidates under designated and optional trades, determining the applicability of Basic Training, and registering or aligning Basic Training Providers.
          ...
          <div className='sm:flex sm:w-full sm:mt-12 mb-12 sm:mb-0'>
            <div className='sm:w-[60%] ml-2 sm:ml-20'>
              <div className='w-full flex justify-start'>
                <h3 className='sm:text-4xl text-2xl font-poppins font-[300]'>MERAQUI AS THIRD PARTY AGGREGATOR </h3>
              </div>
              <p className='text-left font-poppins font-[300] mt-2 sm:mt-8 leading-[35px] sm:text-[1.2rem] sm:mr-4'>•	To Facilitate registration of Establishment, Basic Training Centre, or mapping of Basic Training Provider
              <br></br>
...
<br></br>
          ...
          <div className='sm:flex sm:w-full sm:mt-12 mb-12 sm:mb-0'>
            <div className='sm:w-[60%] ml-2 sm:ml-20'>
              <div className='w-full flex justify-start'>
                <h3 className='sm:text-4xl text-2xl font-poppins font-[300]'>BENEFITS TO YOUR ORGANIZATION</h3>
              </div>
              <p className='text-left font-poppins font-[300] mt-2 sm:mt-8 leading-[35px] sm:text-[1.2rem] sm:mr-4'>•	Address the skill gap for the establishment
              <br></br>
