        ...
        <section className='sm:flex sm:flex-row sm:mt-12 sm:w-full font-poppins font-[300]'>
                ...
                <div  className='sm:relative sm:left-[20%] sm:h-[65vh] sm:w-[90%] bg-getInTouch h-[40vh] bg-center bg-cover w-[100%]'>
                    <div className='w-full sm:flex sm:flex-col sm:justify-center sm:h-[65vh] h-[40vh] bg-black bg-opacity-[0.6] sm:bg-opacity-[0.5] text-white'>
                        <div className='w-full sm:flex sm:justify-end sm:pr-16 py-4'>
                            <h2 className='font-quicksand font-[400] text-2xl sm:text-3xl sm:text-right sm:w-[85%] mr'>Get in touch with us. Let's talk!</h2>
                        </div>
                        <div className='w-full  sm:flex sm:justify-end sm:pr-16 py-4'>
                            <p className='w-[95%] font-quicksand font-[400] text-[1rem] text-left pl-2  sm:text-left sm:w-[60%] sm:leading-[1.8]'>
            ...
            <div className=' my-8 w-full sm:w-[35%]'>
                <div className='w-full sm:w-[75%] flex justify-center '>
                    <input className='sm:w-[100%] rounded outline-none w-[85%] p-2 text-black font-quicksand font-[500] h-[5vh] border-[1px] border-black' type="text" placeholder='Name' name="" id="" />
                </div>
                <div className='w-full flex justify-center mt-4 sm:w-[75%]'>
                    <input className='sm:w-[100%] rounded outline-none w-[85%] p-2 text-black font-quicksand font-[500] h-[5vh] border-[1px] border-black' type="text" placeholder='Designation' name="" id="" />
                </div>
                <div className='w-full flex justify-center mt-4 sm:w-[75%]'>
                    <input className='sm:w-[100%] rounded outline-none w-[85%] p-2 text-black font-quicksand font-[500] h-[5vh] border-[1px] border-black' type="text" placeholder='Organization' name="" id="" />
                </div>
                <div className='w-full flex justify-center mt-4 sm:w-[75%]'>
                    <input className='sm:w-[100%] rounded outline-none w-[85%] p-2 text-black font-quicksand font-[500] h-[5vh] border-[1px] border-black' type="email" placeholder='Official Email Id' name="" id="" />
                </div>
                <div className='w-full flex justify-center mt-4  sm:w-[75%]'>
                    <input className='sm:w-[100%] rounded outline-none w-[85%] p-2 text-black font-quicksand font-[500] h-[5vh] border-[1px] border-black' type="number" placeholder='Contact no.' name="" id="" />
                </div>
                <div className='w-full flex justify-center mt-4 sm:w-[75%]'>
                    <input className='sm:w-[100%] rounded outline-none w-[85%] p-2 text-black font-quicksand font-[500] h-[5vh] border-[1px] border-black' type="text" placeholder='Enquiry type' name="" id="" />
                </div>
                <div className='w-[93%] mt-4 flex justify-end sm:justify-start'>
                    <button className='w-[40%] h-[5vh] bg-cyan-200 font-quicksand font-[500] rounded' type='submit' >Submit</button>
                </div>
            </div>
        </section>
    </main>
