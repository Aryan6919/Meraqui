        ...
        <section className='w-full my-12 sm:mt-20'>
          ...
          <div className='sm:flex sm:w-full sm:mt-4 mb-12 sm:mb-0'>
            <div className='sm:w-[60%] ml-2 sm:ml-20'>
              ...
              <p className='text-left font-poppins font-[300] mt-2 sm:mt-8 leading-[35px] sm:text-[1.2rem] sm:mr-4'>NEEM (The objective here is to develop “trainees” into a competent workforce, who could take the country ahead in the industrial world. World popular concept of “On-The-Job Training” is the basis of this program, targeting enhancement of employability among individuals who are pursuing graduation or have discontinued or completed a diploma or graduation in any technical or non-technical field.)</p>
            </div>
            <div>
