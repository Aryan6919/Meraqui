          ...
          <div className='sm:flex sm:w-full sm:mt-4 mb-12 sm:mb-0'>
            <div className='sm:w-[60%] ml-2 sm:ml-20'>
              <div className='w-full flex justify-start'>
                <h3 className='sm:text-4xl text-2xl font-poppins font-[300] sm:mt-12'>OUR 3PL STRENGTHS INCLUDE </h3>
              </div>
              <p className='text-left font-poppins font-[300] mt-2 sm:mt-8 leading-[35px] sm:text-[1.2rem] sm:mr-4'>•	Inventory Management<br></br>
•	Kitting
<br></br>
...
<br></br>
          ...
          <div className='sm:flex sm:w-full sm:mt-12 mb-12 sm:mb-0'>
            <div className='sm:w-[60%] ml-2 sm:ml-20'>
              <div className='w-full flex justify-start'>
                <h3 className='sm:text-4xl text-2xl font-poppins font-[300] sm:mt-12'>OUR WAREHOUSING VERTICALS</h3>
              </div>
              <p className='text-left font-poppins font-[300] mt-2 sm:mt-8 leading-[35px] sm:text-[1.2rem] sm:mr-4'>•	Central Processing Centre (CPC)<br></br>
•	Distribution Centre
<br></br>
•	Fulfilment Centre
<br></br>
